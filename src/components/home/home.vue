<template>
	<div class = "home">
		...
		<h3 v-if = "articles.all.length === 0 && code === 200" class = "none-article">That's no post，maybe some problem accur...</h3>
...
<script>
	...
	export default {
		...
		metaInfo(){
			return {
				title: "7Ethan -Homepage",
				meta: [{vmid: "description",name: "description",content: "7Ethan -Homepage"}]
			}
		},

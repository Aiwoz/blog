	...
	<div class = "tab" ref = "tab" :class = "{'tab-bg': tabBg}">
		<nav class = "navbar">
			...
			<div class = "nav-body" :class = "{heightZero: show}">
				...
				<div class = "search">
					<input type = "text" placeholder = "Please enter key words" v-model = "searchKey" @keyup.enter = "search">
 	...
 	export default {
		data(){
			return{
				...
				routeName: "",
				intervalId: "",
				tabs: [{name: "home",render: "Home",icon: "icon-home"},{name: "article",render: "Posts",icon: "icon-book"},{name: "msgboard",render: "Message",icon: "icon-messages"},{name: "life",render: "More",icon: "icon-images"}]
			}	
		},
		mounted(){
			requestAnimation()
